This is a boilerplate project using the following tech stack: node.js, express, mongodb, mongoose, backbone.js, require.js, dust.js, and bootstrap. It has barebones ReSTful API logic already written.
